              ...
              <div className="section-list">
                ...
                <div className="lista">
                  <ul>
                    <li>
                      <a href="#">
                        <div>Quali confini tra vita e lavoro</div>{" "}
                        <span>Notizie Principali</span>
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <div>Azimut avrà la sua banca digitale</div>{" "}
                        <span>5 giorni fa</span>
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <div>Lamborghini ritocca il logo</div>{" "}
                        <span>1 giorno fa</span>
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <div>Worldpay integra satispay</div>{" "}
                        <span>16 ore fa</span>
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <div>Private equity in frenata</div>{" "}
                        <span>5 giorni fa</span>
                      </a>
                    </li>
                  </ul>
